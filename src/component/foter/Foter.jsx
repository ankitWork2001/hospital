        ...
        <div className='foterfile mt-10'>
            <div className='grid sm:grid-cols-2 md:grid-cols-4 gap-4 p-4'>
                ...
                <div className='p-3 text-center'>
                    <p className='pt-6 text-2xl text-white font-semibold cursor-pointer hover:underline'>Services</p>
                ...
                <div className='p-3 text-center'>
                    <p className='pt-6 text-2xl text-white font-semibold cursor-pointer hover:underline'>Support</p>
                    <p className='text-gray-300 pt-2 cursor-pointer'>24/7 Emergency</p>
                    <p className='text-gray-300 pt-2 cursor-pointer'>Contact Us</p>
                </div>
                <div className='p-3 text-center'>
                    <p className='pt-6 text-2xl text-white font-semibold cursor-pointer hover:underline'>Contact</p>
