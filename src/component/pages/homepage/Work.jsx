...
const Work = () => {
    return (
        <div>
            <div className='bg-[#E6F5F5] p-2 mt-3 '>
                <p className='text-center font-medium text-3xl pt-2'>How It Works</p>
                ...
                <div className='grid md:grid-cols-3 gap-7 p-4 mt-5'>
                    <div className='bg-white card-service hover:bg-[#019196] hover:text-white cursor-pointer'>
