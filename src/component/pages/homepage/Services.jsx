    ...
    <div className='mt-2'>
      ...
      <div className='grid md:grid-cols-4 gap-4 p-2'>
        <div className='card-service'>
            ...
            <p className='font-bold text-xl pt-1'>ICU Setup at Home</p>
            <p className='pt-2'>Complete intensive care unit setup with ventilators, monitors, and critical care equipment.</p>
            <button className='border rounded-3xl p-1.5 px-3 mt-3 textcolor'>Enquire Now</button>
        </div>
        <div className='card-service'>
            <img className='w-full ' src={rectangle2} alt="" />
            <p className='font-bold text-xl pt-1'>Professional Nursing </p>
            <p className='pt-2'>Qualified nurses providing 24/7 medical care, medication management, and health monitoring.</p>
            <button className='border rounded-3xl p-1.5 px-3  mt-3 textcolor'>Enquire Now</button>
        </div>
        <div className='card-service'>
            <img className='w-full ' src={rectangle3} alt="" />
            <p className='font-bold text-xl pt-1'>GDA Care</p>
            <p className='pt-2'>General Duty Assistants for  daily care activities, patient mobility, and personal assistance.</p>
            <button className='border rounded-3xl p-1.5 px-3 textcolor mt-3'>Enquire Now</button>
        </div>
        <div className='card-service'>
            <img className='w-full ' src={rectangle4} alt="" />
            <p className='font-bold text-xl pt-1'>Medical Equipment</p>
            <p className='pt-2'>Rent or purchase hospital-grade medical equipment for home care needs.</p>
            <button className='border rounded-3xl p-1.5 px-3 textcolor mt-3'>Enquire Now</button>
        </div>
      </div>
    </div>
