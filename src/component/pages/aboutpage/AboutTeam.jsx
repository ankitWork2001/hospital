...
import teammemberimg1 from "../../../assets/aboutimg/Rectangle 4517.png"
import teammemberimg2 from "../../../assets/aboutimg/Rectangle 4518.png"
import teammemberimg3 from "../../../assets/aboutimg/Rectangle 4519.png"
    ...
    <div className='mt-4'>
      ...
      <div className='grid md:grid-cols-3 gap-5 p-3'>
        ...
        <div className='mt-2 p-1'>
            ...
            <p className='text-xl text-center font-medium'>Ganesh Krishnan</p>
            <p className='text-center pt-1'>Co-founder & Director</p>
        </div>
        <div className='mt-2 p-1'>
            <img src={teammemberimg3} alt="" />
            <p className='text-xl text-center font-medium'>Vaibhav Tewari</p>
